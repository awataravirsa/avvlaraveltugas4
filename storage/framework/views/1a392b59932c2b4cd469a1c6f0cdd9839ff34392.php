    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <h2>Prodi : <?php echo e($data['mahasiswa']['prodi']); ?></h2>
                <h2>Jurusan : <?php echo e($data['mahasiswa']['jurusan']); ?></h2>
                <h2>Fakultas : <?php echo e($data['mahasiswa']['fakultas']); ?></h2>
            </div>
        </div>
    </div>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\aav\resources\views/admin/beranda.blade.php ENDPATH**/ ?>